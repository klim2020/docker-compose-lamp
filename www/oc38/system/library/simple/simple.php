...
class Simple
{
    ...
    {
        $wtfpl_dump_rosy_click = $this->readSetting('rows', $wtfpl_blood_macho_cough);
    ...
    private function readSetting($name, $block = "")
    {
        return $this->wtfpl_coil_back_suck($this->wtfpl_lust_thin_lunge, $block, $name);
    }
    ...
    {
        return $this->readSetting($name, $block);
    }
...
'
    ...
    private function wtfpl_skill_angry_buck($wtfpl_stump_cool_chuck, $wtfpl_strap_dutch_pique, $wtfpl_crack_snug_tense)
    {
        ...
        if (!empty($wtfpl_trail_windy_bolt)) {
            ...
            if ($this->readSetting('clearUnusedFields')) {
